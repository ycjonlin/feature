...
module.exports =
  ...
  # downsize
  # --
  # Shrink the last 3 sub-places of a 1-componented Float32Array object onto the first sub-plane of another Float32Array object (could also be the same one).
