  ...
  compact: (oppum, opend0, opend1, opend2, count1, step1, count0, step0)->
    ...
    while index1 < count1
      ...
      while index0 < count0
        ...
        value0 = if value0 > 0.0031308 then 
          fround(1.055*pow(value0, 1/2.4)) else 
          fround(12.92*value0)
        value1 = if value1 > 0.0031308 then 
          fround(1.055*pow(value1, 1/2.4)) else 
          fround(12.92*value1)
        value2 = if value2 > 0.0031308 then 
          fround(1.055*pow(value2, 1/2.4)) else 
          fround(12.92*value2)
  ...
  flatten: (oppum, opend, count1, step1, count0, step0)->
    ...
    while index1 < count1
      ...
      while index0 < count0
        ...
        channel = if channel > 0.0031308 then 
          fround(1.055*pow(channel, 1/2.4)) else 
          fround(12.92*channel)
